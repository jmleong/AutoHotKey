...
if defined %slot% call echo slot detected && goto:SigTesting_PCIeTx 
if defined %port% call echo port detected && goto:SigTesting_NVME
...
for %%A in (!slot!) do (
 ...
 echo S%%A_P01_d_LANE%%B


      IF NOT "%preset%"=="" @(
			      if exist %wfm_path%\slot%%A\S%%A_P01_d_LANE%%B.wfm %sigtest% /P /d %wfm_path%\slot%%A /s 
			      if exist %wfm_path%\slot%%A\S%rd%_P01_d_LANE%%B_Math2.wfm %sigtest% /P /d %wfm_path%\slot%%A /s
			     )

      IF NOT "%gen1%"=="" @(
			    if exist %wfm_path%\slot%%A\S%%A_GEN1_LANE%%B.wfm  %Sigtest% /d %wfm_path%\slot%%A /s S%%A_GEN1_LANE%%B.wfm /t %template1% /o slot%%A.txt 
			    if exist %wfm_path%\slot%%A\S%%A_GEN1_LANE%%B_Math2.wfm  %Sigtest% /d %wfm_path%\slot%%A /s S%%A_GEN1_LANE%%B_Math2.wfm /t %template1% /o slot%%A.txt
			   )  

      IF NOT "%gen2%"=="" @(
                            if exist %wfm_path%\slot%%A\S%%A_GEN2_LANE%%B_35.wfm  %Sigtest% /d %wfm_path%\slot%%A /s S%%A_GEN2_LANE%%B_35.wfm /cs CLOCK.wfm /t %template2% /o slot%%A.txt 
                            if exist %wfm_path%\slot%%A\S%%A_GEN2_LANE%%B_6.wfm   %Sigtest% /d %wfm_path%\slot%%A /s S%%A_GEN2_LANE%%B_6.wfm /cs CLOCK.wfm /t %template2% /o slot%%A.txt
                            if exist %wfm_path%\slot%%A\S%%A_GEN2_LANE%%B.wfm   %Sigtest% /d %wfm_path%\slot%%A /s S%%A_GEN2_LANE%%B.wfm /cs CLOCK.wfm /t %template2% /o slot%%A.txt
			    if exist %wfm_path%\slot%%A\S%%A_GEN2_LANE%%B_35_Math2.wfm  %Sigtest% /d %wfm_path%\slot%%A /s S%%A_GEN2_LANE%%B_35_Math2.wfm /cs S%%A_GEN2_LANE%%B_35_Math1.wfm /t %template2% /o slot%%A.txt 
                            if exist %wfm_path%\slot%%A\S%%A_GEN2_LANE%%B_6_Math2.wfm   %Sigtest% /d %wfm_path%\slot%%A /s S%%A_GEN2_LANE%%B_6_Math2.wfm /cs S%%A_GEN2_LANE%%B_6_Math1.wfm /t %template2% /o slot%%A.txt
                            if exist %wfm_path%\slot%%A\S%%A_GEN2_LANE%%B_Math2.wfm   %Sigtest% /d %wfm_path%\slot%%A /s S%%A_GEN2_LANE%%B_Math2.wfm /cs S%%A_GEN2_LANE%%B_Math1.wfm /t %template2% /o slot%%A.txt
                           )


      IF NOT "%gen3%"=="" @(
                     if exist %wfm_path%\slot%%A\S%%A_P00_d_LANE%%B.wfm  %Sigtest% /d %wfm_path%\slot%%A /s S%%A_P00_d_LANE%%B.wfm /cs CLOCK.wfm /t %template3% /o slot%%A.txt 
                     if exist %wfm_path%\slot%%A\S%%A_P07_d_LANE%%B.wfm  %Sigtest% /d %wfm_path%\slot%%A /s S%%A_P07_d_LANE%%B.wfm /cs CLOCK.wfm /t %template3% /o slot%%A.txt 
                     if exist %wfm_path%\slot%%A\S%%A_P08_d_LANE%%B.wfm  %Sigtest% /d %wfm_path%\slot%%A /s S%%A_P08_d_LANE%%B.wfm /cs CLOCK.wfm /t %template3% /o slot%%A.txt 
                     if exist %wfm_path%\slot%%A\S%%A_GEN3_LANE%%B.wfm  %Sigtest% /d %wfm_path%\slot%%A /s S%%A_GEN3_LANE%%B.wfm /cs CLCOK.wfm /t %template3% /o slot%%A.txt
                     if exist %wfm_path%\slot%%A\S%%A_GEN3_LANE%%B_P00.wfm  %Sigtest% /d %wfm_path%\slot%%A /s S%%A_GEN3_LANE%%B_P00.wfm /cs CLOCK.wfm /t %template3% /o slot%%A.txt
                     if exist %wfm_path%\slot%%A\S%%A_GEN3_LANE%%B_P07.wfm  %Sigtest% /d %wfm_path%\slot%%A /s S%%A_GEN3_LANE%%B_P07.wfm /cs CLOCK.wfm /t %template3% /o slot%%A.txt
                     if exist %wfm_path%\slot%%A\S%%A_GEN3_LANE%%B_P08.wfm  %Sigtest% /d %wfm_path%\slot%%A /s S%%A_GEN3_LANE%%B_P08.wfm /cs CLOCK.wfm /t %template3% /o slot%%A.txt
                     if exist %wfm_path%\slot%%A\S%%A_P00_d_LANE%%B_Math2.wfm  %Sigtest% /d %wfm_path%\slot%%A /s S%%A_P00_d_LANE%%B_Math2.wfm /cs S%%A_P00_d_LANE%%B_Math1.wfm /t %template3% /o slot%%A.txt 
                     if exist %wfm_path%\slot%%A\S%%A_P07_d_LANE%%B_Math2.wfm  %Sigtest% /d %wfm_path%\slot%%A /s S%%A_P07_d_LANE%%B_Math2.wfm /cs S%%A_P07_d_LANE%%B_Math1.wfm /t %template3% /o slot%%A.txt 
                     if exist %wfm_path%\slot%%A\S%%A_P08_d_LANE%%B_Math2.wfm  %Sigtest% /d %wfm_path%\slot%%A /s S%%A_P08_d_LANE%%B_Math2.wfm /cs S%%A_P08_d_LANE%%B_Math1.wfm /t %template3% /o slot%%A.txt 
                     if exist %wfm_path%\slot%%A\S%%A_GEN3_LANE%%B_Math2.wfm  %Sigtest% /d %wfm_path%\slot%%A /s S%%A_GEN3_LANE%%B_Math2.wfm /cs S%%A_GEN3_LANE%%B_Math1.wfm /t %template3% /o slot%%A.txt
                     if exist %wfm_path%\slot%%A\S%%A_GEN3_LANE%%B_P00_Math2.wfm  %Sigtest% /d %wfm_path%\slot%%A /s S%%A_GEN3_LANE%%B_P00_Math2.wfm /cs S%%A_GEN3_LANE%%B_P00_Math1.wfm /t %template3% /o slot%%A.txt
                     if exist %wfm_path%\slot%%A\S%%A_GEN3_LANE%%B_P07_Math2.wfm  %Sigtest% /d %wfm_path%\slot%%A /s S%%A_GEN3_LANE%%B_P07_Math2.wfm /cs S%%A_GEN3_LANE%%B_P07_Math1.wfm /t %template3% /o slot%%A.txt
                     if exist %wfm_path%\slot%%A\S%%A_GEN3_LANE%%B_P08_Math2.wfm  %Sigtest% /d %wfm_path%\slot%%A /s S%%A_GEN3_LANE%%B_P08_Math2.wfm /cs S%%A_GEN3_LANE%%B_P08_Math1.wfm /t %template3% /o slot%%A.txt 
                          )
